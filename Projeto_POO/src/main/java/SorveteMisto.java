...
public class SorveteMisto extends Sorvete implements Granulado{

    public SorveteMisto(String sabor, double preco, Recipiente recipiente) {
    ...
    public void addRecipiente(@NotNull String rec) {
        if(rec.equals("copinho")){
            ...
            System.out.println("Sorvete misto sera no copinho;");
        }
        else if (rec.equals("casquinha")){
            this.recipiente = new Casquinha("casquinha");
            System.out.println("Sorvete misto sera na casquiha;");
        }
        else{
