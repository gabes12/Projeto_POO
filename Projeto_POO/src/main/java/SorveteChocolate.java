...
public class SorveteChocolate extends Sorvete implements Granulado{

    public SorveteChocolate(String sabor, double preco, Recipiente recipiente) {
    ...
    public void addRecipiente(@NotNull String rec) {
        if(rec.equals("copinho")){
            ...
            System.out.println("Sorvete de choclate sera no copinho;");
        }
        else if (rec.equals("casquinha")){
            this.recipiente = new Casquinha("casquinha");
            System.out.println("Sorvete de choclate sera na casquiha;");
        }
        else{
