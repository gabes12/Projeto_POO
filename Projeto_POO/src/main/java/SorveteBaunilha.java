...
public class SorveteBaunilha extends Sorvete implements Granulado{

    public SorveteBaunilha(String sabor, double preco, Recipiente recipiente) {
    ...
    public void addRecipiente(@NotNull String rec) {
        if(rec.equals("copinho")){
            ...
            System.out.println("Sorvete de baunilha sera no copinho;");
        }
        else if (rec.equals("casquinha")){
            this.recipiente = new Casquinha("casquinha");
            System.out.println("Sorvete de baunilha sera na casquiha;");
        }
        else{
